...
Get-NtSystemInformation -ModuleInformation
...
Get-NtSystemInformation -HandleInformation
...
Get-NtSystemInformation -ObjectInformation
...
Get-NtSystemInformation -GlobalFlags
